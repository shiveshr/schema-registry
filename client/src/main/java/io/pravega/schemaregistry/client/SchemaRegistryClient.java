...
public interface SchemaRegistryClient {
     ...
     * @param scope scope id for the group. 
     * @return True indicates if the group was added successfully, false if it exists. 
     */
    boolean addGroup(String scope, String groupId, SchemaType schemaType, SchemaValidationRules validationRules,
     ...
     * @param groupId Id for the group that uniquely identifies the group. 
     */
    void removeGroup(String scope, String groupId);
     ...
     */
    Map<String, GroupProperties> listGroups(String scope);
     ...
     */
    void updateSchemaValidationRules(String scope, String groupId, SchemaValidationRules validationRules);
     ...
     */
    List<String> getSchemaNames(String scope, String groupId);
     ...
     */
    VersionInfo addSchema(String scope, String groupId, SchemaInfo schema);
     ...
     */
    void deleteSchemaVersion(String scope, String groupId, VersionInfo version);
     ...
     */
    SchemaInfo getSchemaForVersion(String scope, String groupId, VersionInfo version);
     ...
     */
    EncodingId getEncodingId(String scope, String groupId, VersionInfo version, CodecType codecType);
     ...
     */
    SchemaWithVersion getLatestSchemaVersion(String scope, String groupId, @Nullable String schemaName);
     ...
     */
    VersionInfo getVersionForSchema(String scope, String groupId, SchemaInfo schema);
     ...
     */
    List<SchemaWithVersion> getSchemaVersions(String scope, String groupId, @Nullable String schemaName);
     ...
     */
    boolean validateSchema(String scope, String groupId, SchemaInfo schema);
     ...
     */
    boolean canReadUsing(String scope, String groupId, SchemaInfo schema);
     ...
     */
    List<CodecType> getCodecTypes(String scope, String groupId);
     ...
     * @param codecType codec type.
     */
    void addCodecType(String scope, String groupId, CodecType codecType);
     ...
     * @return Ordered list of schemas with versions and validation rules for all schemas in the group. 
     */
    List<GroupHistoryRecord> getGroupHistory(String scope, String groupId);
}
