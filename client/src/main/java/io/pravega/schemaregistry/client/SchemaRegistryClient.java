...
public interface SchemaRegistryClient {
     ...
     * @param tenant tenant id for the group. 
     * @return True indicates if the group was added successfully, false if it exists. 
     */
    boolean addGroup(String tenant, String groupId, SchemaType schemaType, SchemaValidationRules validationRules,
     ...
     * @param groupId Id for the group that uniquely identifies the group. 
     */
    void removeGroup(String tenant, String groupId);
     ...
     */
    Map<String, GroupProperties> listGroups(String tenant);
     ...
     */
    GroupProperties getGroupProperties(String tenant, String groupId);
     ...
     */
    void updateSchemaValidationRules(String tenant, String groupId, SchemaValidationRules validationRules);
     ...
     */
    List<String> getSchemaNames(String tenant, String groupId);
     ...
     */
    VersionInfo addSchema(String tenant, String groupId, SchemaInfo schema);
     ...
     */
    void deleteSchemaVersion(String tenant, String groupId, VersionInfo version);
     ...
     */
    SchemaInfo getSchemaForVersion(String tenant, String groupId, VersionInfo version);
     ...
     */
    EncodingInfo getEncodingInfo(String tenant, String groupId, EncodingId encodingId);
     ...
     */
    EncodingId getEncodingId(String tenant, String groupId, VersionInfo version, CodecType codecType);
     ...
     */
    SchemaWithVersion getLatestSchemaVersion(String tenant, String groupId, @Nullable String schemaName);
     ...
     */
    VersionInfo getVersionForSchema(String tenant, String groupId, SchemaInfo schema);
     ...
     */
    List<SchemaWithVersion> getSchemaVersions(String tenant, String groupId, @Nullable String schemaName);
     ...
     * This api performs exactly the same validations as {@link SchemaRegistryClient#addSchema(String, String, SchemaInfo)}
     ...
     */
    boolean validateSchema(String tenant, String groupId, SchemaInfo schema);
     ...
     */
    boolean canReadUsing(String tenant, String groupId, SchemaInfo schema);
     ...
     */
    List<CodecType> getCodecTypes(String tenant, String groupId);
     ...
     * @param codecType codec type.
     */
    void addCodecType(String tenant, String groupId, CodecType codecType);
     ...
     * @return Ordered list of schemas with versions and validation rules for all schemas in the group. 
     */
    List<GroupHistoryRecord> getGroupHistory(String tenant, String groupId);
}
