 ...
 * {@link GroupProperties#validateBySchemaName} that specifies if schemas have validation rules applied for schemas that share the 
 ...
 * If validateBySchemaName is set to true, then schemas are validate against other schemas in the group that share the same 
...
public class GroupProperties {
    ...
    public static final class GroupPropertiesBuilder {
        ...
        private boolean validateBySchemaName = false;
