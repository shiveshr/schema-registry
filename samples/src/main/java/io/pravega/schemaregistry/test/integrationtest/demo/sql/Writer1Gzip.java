...
public class Writer1Gzip {
    ...
    private Writer1Gzip(String controllerURI, String registryUri, String scope, String stream) {
    ...
    public static void main(String[] args) {
        ...
        Writer1Gzip producer = new Writer1Gzip(controllerUri, registryUri, scope, stream);
