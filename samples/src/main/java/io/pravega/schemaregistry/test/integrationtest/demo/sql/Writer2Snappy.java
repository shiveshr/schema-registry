...
public class Writer2Snappy {
    ...
    private Writer2Snappy(String controllerURI, String registryUri, String scope, String stream) {
    ...
    public static void main(String[] args) {
        ...
        Writer2Snappy producer = new Writer2Snappy(controllerUri, registryUri, scope, stream);
