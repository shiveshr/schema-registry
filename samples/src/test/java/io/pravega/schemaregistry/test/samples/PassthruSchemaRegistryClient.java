...
public class PassthruSchemaRegistryClient implements SchemaRegistryClient {
    ...
    @Override
    public boolean addGroup(String scope, String group, SchemaType schemaType, SchemaValidationRules validationRules,
    ...
    @Override
    public List<String> getSchemaNames(String scope, String group) {
        return service.getSchemaNames(group).join();
    }

    @Override
    public VersionInfo addSchema(String scope, String group, SchemaInfo schema) {
    ...
    @Override
    public SchemaInfo getSchemaForVersion(String scope, String group, VersionInfo version) {
    ...
    @Override
    public EncodingId getEncodingId(String scope, String group, VersionInfo version, CodecType codecType) {
        return service.getEncodingId(group, version, codecType).join();
    }

    @Override
    public SchemaWithVersion getLatestSchemaVersion(String scope, String group, @Nullable String subgroup) {
    ...
    @Override
    public List<GroupHistoryRecord> getGroupHistory(String scope, String group) {
        return service.getGroupHistory(group, null).join();
    }
    
    @Override
    public VersionInfo getVersionForSchema(String scope, String group, SchemaInfo schema) {
        return service.getSchemaVersion(group, schema).join();
    }

    @Override
    public boolean validateSchema(String scope, String group, SchemaInfo schema) {
        return service.validateSchema(group, schema).join();
    }

    @Override
    public boolean canReadUsing(String scope, String group, SchemaInfo schema) {
        return service.canRead(group, schema).join();
    }

    @Override
    public List<CodecType> getCodecTypes(String scope, String group) {
        return service.getCodecTypes(group).join();
    }

    @Override
    public void addCodecType(String scope, String group, CodecType codecType) {
